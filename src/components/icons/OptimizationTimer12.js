...
export default function OptimizationTimer12(props) {
	return (
		...
		>
			...
			<path
				className="cls-1"
				d="M3.906,19.5H2.5a2,2,0,0,1-2-2V2.5a2,2,0,0,1,2-2h19a2,2,0,0,1,2,2v15a2,2,0,0,1-2,2H19.988"
			/>
			<line className="cls-1" x1="0.5" y1="5.5" x2="23.5" y2="5.5" />
			<path
				className="cls-1"
				d="M4,2.75A.25.25,0,1,1,3.75,3,.25.25,0,0,1,4,2.75"
			/>
			<path
				className="cls-1"
				d="M7,2.75A.25.25,0,1,1,6.75,3,.25.25,0,0,1,7,2.75"
			/>
			<path
				className="cls-1"
				d="M10,2.75A.25.25,0,1,1,9.75,3,.25.25,0,0,1,10,2.75"
			/>
