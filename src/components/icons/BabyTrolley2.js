...
const BabyTrolley2 = props => {
	return (
		...
		>
			...
			<path
				className="cls-1"
				d="M18.5,10.528V15H13.03a.508.508,0,0,0-.5.577A5.018,5.018,0,0,0,17.5,20h.764a5.162,5.162,0,0,0,5.21-4.487,5.014,5.014,0,0,0-4.447-5.485A.493.493,0,0,0,18.5,10.528Z"
			/>
			...
			<path
				className="cls-1"
				d="M9.448,4.6A4.635,4.635,0,0,1,6,3,4.635,4.635,0,0,1,2.552,4.6"
			/>
			<path
				className="cls-1"
				d="M9.7,11.918a3.8,3.8,0,0,0-7.39,0L.5,18.5h3l1,5h3l1-5h3Z"
			/>
