...
export default function ShopCashierWoman2(props) {
	return (
		...
		>
			...
			<path
				className="cls-1"
				d="M17.1,9.6a5.506,5.506,0,0,1-.8-3.054V5.3A4.3,4.3,0,1,0,7.7,5.3V6.546A5.506,5.506,0,0,1,6.9,9.6"
			/>
			<path
				className="cls-1"
				d="M7.7,6.006A5.687,5.687,0,0,0,12,4.037a5.687,5.687,0,0,0,4.3,1.969"
			/>
